...
//! `efterscript_fonts::Program`. The dictionary entries are read as the VM sees
...
use efterscript_fonts::truetype::CidMap;
use efterscript_fonts::type1::Type1Dict;
use efterscript_fonts::{Program, TrueTypeProgram, Type1Program};
