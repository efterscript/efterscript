...
use efterscript_fonts::{CMap, Program};
...
pub struct Interp {
    ...
    pub(crate) resident_fonts: [Option<Object>; efterscript_fonts::ResidentFace::COUNT],
...
impl Interp {
    ...
    pub fn try_with_config(config: Config) -> Result<Self, PreludeError> {
        ...
        let standard_encoding =
            ops::font::encoding_array(&mut mem, &efterscript_fonts::STANDARD_ENCODING)
                .expect("names are simple objects");
        let iso_latin1_encoding =
            ops::font::encoding_array(&mut mem, &efterscript_fonts::ISO_LATIN1_ENCODING)
                .expect("names are simple objects");
        ...
        let mut interp = Interp {
            ...
            standard_encoding,
            iso_latin1_encoding,
            resident_fonts: [None; efterscript_fonts::ResidentFace::COUNT],
