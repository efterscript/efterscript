...
mod tests {
    ...
    use efterscript_graphics::{ImageRef, Op};
    use efterscript_vm::{Bounds, LineCap, LineJoin};
    ...
    fn a_pattern_colour_names_the_pattern_in_its_space() {
        use efterscript_graphics::{FormIndex, PatternSpec};
        let mut page = page(Vec::new());
        let plain = page
            .resources
    ...
    fn a_shade_operation_names_its_shading_under_its_matrix() {
        use efterscript_graphics::ShadingIndex;
        let page = page(vec![
            IrOp::Shade {
    ...
    fn a_shading_pattern_is_selected_like_a_tiling_pattern() {
        use efterscript_graphics::{PatternSpec, ShadingIndex};
        let mut page = page(Vec::new());
