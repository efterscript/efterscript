...
use efterscript_graphics::{Annot, DocMark, LinkTarget, PageAttrs, Target, View};
use efterscript_pdf::{ArrayBuilder, DictBuilder, Document, Error, Ref};
...
mod tests {
    ...
    fn page_attributes_layer_over_the_defaults() {
        ...
        marks.record(DocMark::PagesDefault(PageAttrs {
            crop_box: Some(efterscript_vm::Bounds::new(0.0, 0.0, 1.0, 1.0)),
            rotate: Some(90),
        }));
