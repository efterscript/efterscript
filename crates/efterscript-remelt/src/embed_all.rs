...
use efterscript_fonts::{Program, ResidentFace, ResidentOutlines, TrueTypeProgram};
use efterscript_graphics::{FontSpec, GlyphNames, ProgramRef};
use efterscript_pdf::{Document, Filter};
...
fn write_truetype<W: Write>(
    ...
    let bytes = efterscript_fonts::truetype::write::subset(asset.program, &gids, &cmap)
