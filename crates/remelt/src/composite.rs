...
use ps_fonts::cff::{self, Privates};
use ps_fonts::{Outline, OutlineOp, Program, ProgramKind, TrueTypeProgram, truetype};
use ps_graphics::{FillRule, FontSpec, IrOp, Resources};
use ps_vm::{Matrix, Point, Seg};
...
fn write_cff_descendant<W: Write>(
    ...
    cids: &BTreeSet<u16>,
    filter: Filter,
) -> Result<Descendant, pdf_out::Error> {
