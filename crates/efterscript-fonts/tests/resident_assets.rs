...
use efterscript_fonts::type1::write::{
    Header, pruned_subrs, reachable_subrs, renumber, subset_names, write,
};
use efterscript_fonts::type1::{FileEncoding, parse_file};
#[cfg(feature = "resident-outlines")]
use efterscript_fonts::{ResidentFace, StdFont};
use efterscript_fonts::{STANDARD_ENCODING, TrueTypeProgram, Type1Program};
...
fn every_metric_glyph_name_resolves_in_its_outline_asset() {
        ...
        .filter(|f| f.std_font().is_none())
    {
        ...
        assert_eq!(
            ...
            efterscript_fonts::ProgramKind::Type1
        );
    }
}
